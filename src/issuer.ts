...
export const issuer = new Agent({
  ...
  modules: {
    ...
    polygon: new PolygonModule({
      ...
      fileServerToken:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJBeWFuV29ya3MiLCJpZCI6IjU5N2FmODBmLTA0MDUtNDJkOC1hMmIyLWU2YjBlNDllOTI1MCJ9.qZ4O23qastQSnYjeUDs0Ha-EpZjs8G_0IGPeye432Yo',
      schemaManagerContractAddress: '0x67e8223D80aEcb337FE8D90dD41845A0DA31B4b0',
      serverUrl: 'https://3c48-103-97-166-226.ngrok-free.app',
    }),
